...
function Header() {
  ...
  const [joury, setJoury] = useState(false);
  ...
  useEffect(() => {
    setTimeout(() => {
      const id = localStorage.getItem("id");
      axios
        .post("/auth/getUser", { userId: id, type: "logo" })
        .then((res) => res.data)
        .then((data) => {
    ...
    <>
      <div className={s.container}>
        ...
        <div className={s.links}>
          ...
          <p
            onClick={() => navigate("/critery")}
            style={
              location && location.pathname == "/critery"
                ? { color: "#f4444a" }
                : {}
            }
          >
          ...
          <p
            ...
            style={
              location && location.pathname == "/nominations"
                ? { color: "#f4444a" }
                : {}
            }
          >
          ...
          <p
            onClick={() => navigate("/joury")}
            style={
              location && location.pathname == "/joury"
                ? { color: "#f4444a" }
                : {}
            }
          >
          ...
          {dateJoury == false && (
            <p
              ...
              style={
                location && location.pathname == "/results"
                  ? { color: "#f4444a" }
                  : {}
              }
            >
          ...
          <p
            ...
            style={
              location && location.pathname == "/journal"
                ? { color: "#f4444a" }
                : {}
            }
          >
        ...
        >
          {deadline && (
            <p className={s.dataText}>
              {deadline.deadline}-{deadline.deadline2}
            </p>
          )}
          <div>
            {deadline && <p>{deadline.month}</p>}
        ...
        {user?.name ? (
          <div style={{ cursor: "pointer" }} className={s.name}>
            ...
            >
              Баланс: {user && user.balance} заявок
            </p>
          </div>
        ) : (
          <div
        ...
        {joury == true ? (
          <button className={s.viewBtn} onClick={() => navigate("/grading")}>
            Голосование
          </button>
        ) : (
          <button
      ...
      <div className={s.mobileContainer}>
        ...
        ></img>
        <img
          className={s.burgerMenuBtn}
          onClick={() => setBurgerMenu(true)}
          src="/images/nimbus_menu.svg"
        ></img>
        {burgerMenu && (
          <div className={s.burgerMenu}>
            <div className={s.inner}>
              <div className={s.closeDiv}>
                <img
                  src="/images/clarity_close-line.svg"
              ...
              <div className={s.links}>
                ...
                {joury == true && (
                  <p
                    ...
                    style={
                      location && location.pathname == "/grading"
                        ? { color: "#f4444a" }
                        : {}
                    }
                  >
