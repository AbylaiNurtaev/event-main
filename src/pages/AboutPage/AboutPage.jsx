    ...
    return (
        <div className={s.container}>
                ...
                <div className={s.right}>
                    ...
                    <div className={s.blocks}>
                        <div className={s.block}>
                            <h1>2023</h1>
                            <p>Основание рейтинга, начало новой эры в свадебной индустрии Казахстана.</p>
                        </div>
                        <div className={s.block}>
                            <h1>38</h1>
            ...
            <div className={s.goals}>
                ...
                <p className={s.par}>Будем честны: сейчас мы доросли до действительно независимого и уникального рейтинга. Мы творческие и самобытные, а значит идеальный рейтинг специалистов и идеальную церемонию можем создать только мы сами. И нам важно, чтобы нам доверяли не просто разнообразные специалисты со всего мира... Нам должны доверять наши клиенты. Поэтому в 2024 году мы создали WEDS - мощную инфраструктуру для развития свадебных специалистов, которая включает в себя РЕЙТИНГ WEDS, журнал о современных свадьбах в Казахстане WEDS MEDIA, образовательный проект WEDS FORUM и многое другое. И, конечно, Церемонию награждения победителей рейтинга WEDS.
                </p>
