    ...
    <div className={s.container}>
        <div className={s.innerContainer}>
            ...
            <div className={s.buttons}>
                ...
                <button className={s.right} onClick={() => navigate('/application/new')}>УЧАСТВОВАТЬ<br className={s.mobileBR}/> В РЕЙТИНГЕ - 2024</button>
                <button className={s.left} onClick={() => window.open('https://wedsforum.kz')}>БИЛЕТ НА ФОРУМ</button>
            </div>
            ...
            <div className={s.infoBlock}>
                <div className={s.left}>
                    ...
                    <p className={s.par}>Мы — независимый рейтинг, объединяющий свадебных профессионалов и формирующая стандарты индустрии.<br/><br/><br/>
                    Победителем может стать любая компания или частное лицо, предлагающие качественные свадебные услуги. Жюри, состоящее из признанных экспертов свадебного бизнеса, ежегодно обновляется. Участие в рейтинге — это престиж для любого свадебного профессионала!</p>
                    <button onClick={() => navigate('/about')}>ПОДРОБНЕЕ О РЕЙТИНГЕ</button>
                </div>
                <div className={s.right}>
                    ...
                    <p className={s.par}>Ritz-Carlton Astana</p>
                    <button style={{ height: '50px', width: "250px" }} onClick={() => window.location.href="https://wa.me/77777670832?text=%D0%94%D0%BE%D0%B1%D1%80%D1%8B%D0%B9%20%D0%B4%D0%B5%D0%BD%D1%8C!%20%D0%A5%D0%BE%D1%87%D1%83%20%D0%B1%D1%8B%D1%82%D1%8C%20%D0%B7%D1%80%D0%B8%D1%82%D0%B5%D0%BB%D0%B5%D0%BC!%20"}>СТАТЬ ЗРИТЕЛЕМ</button>
                    ...
                    <p className={s.par}>Дворец Мира и Согласия, "Пирамида"</p>
                    <button onClick={() => window.location.href="https://api.whatsapp.com/send/?phone=77777670832&text=%D0%94%D0%BE%D0%B1%D1%80%D1%8B%D0%B9+%D0%B4%D0%B5%D0%BD%D1%8C%21+%D0%A5%D0%BE%D1%87%D1%83+%D0%B1%D1%8B%D1%82%D1%8C+%D0%B7%D1%80%D0%B8%D1%82%D0%B5%D0%BB%D0%B5%D0%BC%21+&type=phone_number&app_absent=0"}>КУПИТЬ БИЛЕТ НА ЦЕРЕМОНИЮ</button>
                </div>
            </div>
